...
public abstract class _UserSliceDisp extends Ice.ObjectImpl implements UserSlice
{
    protected void
    ...
    public Ice.DispatchStatus __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            case 0:
            {
                return ___getUserInfoByPeimaryKey(this, in, __current);
            }
            case 1:
            {
